...
document.getElementById("formJS").addEventListener("submit", function (event) {
  ...
  // Debug: Log form data before sending
    ...
    () => {
      ...
      form.reset(); // Limpia formulario después de enviar el mensaje
      formBtn.setAttribute("disabled", ""); // Deshabilita botón enviar hasta que se llene formulario otra vez
    },
    (err) => {
        btn.textContent = "Send Message";
